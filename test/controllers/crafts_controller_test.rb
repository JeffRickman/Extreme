...
class CraftsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create craft" do
    assert_difference('Craft.count') do
      post crafts_url, params: { craft: { activity_id: @craft.activity_id, category: @craft.category, copyright: @craft.copyright, equipment: @craft.equipment, instructions: @craft.instructions, name: @craft.name } }
    end
  ...
  test "should update craft" do
    patch craft_url(@craft), params: { craft: { activity_id: @craft.activity_id, category: @craft.category, copyright: @craft.copyright, equipment: @craft.equipment, instructions: @craft.instructions, name: @craft.name } }
